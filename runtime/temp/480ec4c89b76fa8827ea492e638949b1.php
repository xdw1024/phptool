<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\phpstudy\WWW\dwtool\public/../application/admin\view\excel\import.html";i:1502090036;s:67:"D:\phpstudy\WWW\dwtool\public/../application/admin\view\layout.html";i:1502068137;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title  am-cf"><h1>门店任务导入</h1></div>
                </div>
                <div class="widget-body  am-fr">
                    ...
                    <div class="am-u-sm-12">
                        <div class="am-form-group">
                            <form  method="post" id ="fileform" action="<?php echo zw_build_url('excel/saveImport'); ?>" class="pageForm required-validate" enctype="multipart/form-data" >
                                <fieldset>
                                    <div class="pageFormContent">
                                        <table>
                                            <tr><label for="excelFile">上传文件：</label></tr>
                                            <tr>
                                                <td><input type="file" class="form-control" id="excelFile" name="excelFile" style="margin: 0px; " /></td>
